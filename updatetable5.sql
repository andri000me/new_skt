...
(161,'5','44','2019-05-01 21:21:42'),
(162,'5','48','2019-05-01 21:21:54'),
(163,'5','53','2019-05-01 21:22:30'),
(164,'5','49','2019-05-01 21:23:03'),
(165,'5','54','2019-05-01 21:23:21'),
(166,'5','50','2019-05-01 21:23:36'),
(167,'5','51','2019-05-01 21:23:59'),
(168,'5','47','2019-05-01 21:24:15'),
(169,'5','45','2019-05-01 21:24:27'),
(170,'5','46','2019-05-01 21:24:50'),
(171,'5','52','2019-05-01 21:25:10'),
(172,'5','43','2019-05-01 21:25:24'),
(173,'5','55','2019-05-01 21:25:50'),
(174,'1','66','2019-05-24 21:10:13'),
(175,'2','66','2019-05-24 21:28:27'),
(176,'1','67','2019-05-24 21:37:26'),
(177,'3','67','2019-05-24 22:13:04');
...
(59,'cetak_bukti_angsuran_pensiun','modul/cetak_bukti_angsuran_pensiun/cetak_bukti_angsuran_pensiun.php','Bagian Cetak Bukti Angsuran Pensiun','Y');
...
(2,'kantor_bayar','Data Kantor Bayar','kantor-bayar.html','fa fa-circle-o text-red',2,0,'Y',4),
(3,'jenis','Data Jenis Pensiun','jenis.html','fa fa-circle-o text-red',2,0,'Y',4),
(4,'nasabah_pensiun','Data Nasabah Pensiun','nasabah-pensiun.html','fa fa-circle-o text-red',2,0,'Y',4),
(5,'transaksi_pensiun','Transaksi Pinjaman Pensiun','transaksi.html','fa fa-circle-o text-red',2,0,'Y',1),
(6,'angsuran_pensiun','Transaksi Angsuran Pensiun','angsuran-pensiun.html','fa fa-circle-o text-red',2,0,'Y',2),
(7,'pelunasan_pensiun','Transaksi Pelunasan Pensiun','pelunasan-pensiun.html','fa fa-circle-o text-red',2,0,'Y',3),
(8,'laporan_penyaluran_kredit_pensiun','Laporan Penyaluran Kredit','laporan-penyaluran-kredit-pensiun.html','fa fa-circle-o text-red',2,0,'Y',5),
(10,'laporan_pelunasan_kredit_pensiun','Laporan Pelunasan Kredit','laporan-pelunasan-kredit-pensiun.html','fa fa-circle-o text-red',2,0,'Y',6),
(11,'laporan_setor_sendiri_kredit_pensiun','Laporan Setor Sendiri','laporan-setor-sendiri-kredit-pensiun.html','fa fa-circle-o text-red',2,0,'Y',7),
(12,'laporan_daftar_nominatif_pensiun','Daftar Nominatif Pensiun','laporan-daftar-nominatif-pensiun.html','fa fa-circle-o text-red',2,0,'Y',8),
(13,'laporan_daftar_pelunasan_pensiun','Daftar Pelunasan Pensiun','laporan-daftar-pelunasan-pensiun.html','fa fa-circle-o text-red',2,0,'Y',9),
(14,'laporan_daftar_tagihan_pensiun','Daftar Tagihan Pensiun','laporan-daftar-tagihan-pensiun.html','fa fa-circle-o text-red',2,0,'Y',10),
(15,'perusahaan','Data Perusahaan','perusahaan.html','fa fa-circle-o text-yellow',3,0,'Y',5),
(16,'nasabah_umum','Data Nasabah Umum','nasabah-umum.html','fa fa-circle-o text-yellow',3,0,'Y',6),
(17,'transaksi_umum','Transaksi Pinjaman Umum','transaksi-umum.html','fa fa-circle-o text-yellow',3,0,'Y',1),
(18,'angsuran_umum','Transaksi Angsuran Umum','angsuran-umum.html','fa fa-circle-o text-yellow',3,0,'Y',3),
(19,'pelunasan_umum','Transaksi Pelunasan Umum','pelunasan-umum.html','fa fa-circle-o text-yellow',3,0,'Y',2),
(20,'realisasi_tagihan_umum','Realisasi Tagihan Umum','realisasi-tagihan-umum.html','fa fa-circle-o text-yellow',3,0,'Y',4),
(21,'laporan_penyaluran_kredit_umum','Laporan Penyaluran Kredit','laporan-penyaluran-kredit-umum.html','fa fa-circle-o text-yellow',3,0,'Y',11),
(22,'laporan_pelunasan_kredit_umum','Laporan Pelunasan Kredit','laporan-pelunasan-kredit-umum.html','fa fa-circle-o text-yellow',3,0,'Y',10),
(23,'laporan_setor_sendiri_kredit_umum','Laporan Setor Sendiri','laporan-setor-sendiri-kredit-umum.html','fa fa-circle-o text-yellow',3,0,'Y',12),
(24,'laporan_daftar_nominatif_umum','Daftar Nominatif Umum','laporan-daftar-nominatif-umum.html','fa fa-circle-o text-yellow',3,0,'Y',9),
(25,'laporan_daftar_pelunasan_umum','Daftar Pelunasan Umum','laporan-daftar-pelunasan-umum.html','fa fa-circle-o text-yellow',3,0,'Y',8),
(26,'laporan_daftar_tagihan_umum','Daftar Tagihan Umum','laporan-daftar-tagihan-umum.html','fa fa-circle-o text-yellow',3,0,'Y',7),
(27,'wilayah','Data Wilayah','wilayah.html','fa fa-circle-o text-aqua',4,0,'Y',4),
(28,'kelompok','Data Kelompok','kelompok.html','fa fa-circle-o text-aqua',4,0,'Y',4),
(29,'nasabah_mikro','Data Nasabah Mikro','nasabah-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',4),
(30,'transaksi_mikro','Transaksi Pinjaman Mikro','transaksi-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',1),
(31,'angsuran_mikro','Transaksi Angsuran Mikro','angsuran-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',2),
(32,'pelunasan_mikro','Transaksi Pelunasan Mikro','pelunasan-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',3),
(33,'realisasi_tagihan_mikro','Realisasi Tagihan Mikro','realisasi-tagihan-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',4),
(34,'laporan_penyaluran_kredit_mikro','Laporan Penyaluran Kredit','laporan-penyaluran-kredit-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',5),
(35,'laporan_pelunasan_kredit_mikro','Laporan Pelunasan Kredit','laporan-pelunasan-kredit-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',6),
(36,'laporan_setor_sendiri_kredit_mikro','Laporan Setor Sendiri','laporan-setor-sendiri-kredit-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',7),
(37,'laporan_daftar_nominatif_mikro','Daftar Nominatif Mikro','laporan-daftar-nominatif-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',8),
(38,'laporan_daftar_pelunasan_mikro','Daftar Pelunasan Mikro','laporan-daftar-pelunasan-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',9),
(39,'laporan_daftar_tagihan_mikro','Daftar Tagihan Mikro','laporan-daftar-tagihan-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',10),
(40,'cetak_bukti_angsuran_mikro','Cetak Bukti Angsuran','cetak-bukti-angsuran-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',11),
(41,'cetak_form_terima_bagi_hasil_mikro','Cetak Form Terima Bagi Hasil','cetak-form-terima-bagi-hasil-mikro.html','fa fa-circle-o text-aqua',4,0,'Y',12),
...
(45,'pinjaman_pensiun','Pinjaman Pensiun','pinjaman-pensiun.html','fa fa-circle-o text-aqua',6,44,'Y',11),
(46,'pinjaman_umum','Pinjaman Umum','pinjaman-umum.html','fa fa-circle-o text-aqua',6,44,'Y',NULL),
(47,'pinjaman_mikro','Pinjaman Mikro','pinjaman-mikro.html','fa fa-circle-o text-aqua',6,44,'Y',13),
...
(66,'cetak_bukti_angsuran_umum','Cetak Bukti Angsuran','cetak-bukti-angsuran-umum.html','fa fa-circle-o text-yellow',3,0,'Y',13),
(67,'cetak_bukti_angsuran_pensiun','Cetak Bukti Angsuran','cetak-bukti-angsuran-pensiun.html','fa fa-circle-o text-red',2,0,'Y',12);
