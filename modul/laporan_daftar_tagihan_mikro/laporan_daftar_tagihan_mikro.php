<?php
error_reporting(0);
//include("modul/laporan_daftar_tagihan_mikro/tampil.php");
include("modul/laporan_daftar_tagihan_mikro/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_daftar_tagihan_mikro/tampil.php ',
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_daftar_tagihan_mikro.php?first='+awal+'&last='+akhir,
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_daftar_tagihan_mikro.php";?>';" >
