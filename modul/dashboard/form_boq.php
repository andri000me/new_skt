	  ...
	  <!-- Tampil SO-->
  <div class="modal fade" id="viewboq" role="dialog">
    <div class="modal-dialog">
     <!-- Modal content-->
        <div class="modal-content">
		  <div class="modal-header">
			 <button type="button" class="close" data-dismiss="modal">&times;</button>
			 <h4 class="modal-title">VIEW BOQ</h4>
		  </div>
		<div class="modal-body">
			  <div class="table-responsive">
       <table id="formboq" class="table  table-striped ">
            
	  <thead>
		<tr>
		  <th>No</th><th></th><th>Nomor Internal User</th><th>Nomor SO</th><th>Judul Pekerjaan</th><th>Nominal BOQ</th>
