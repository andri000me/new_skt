	  ...
	  <!-- Tampil SO-->
  <div class="modal fade" id="viewterbayar" role="dialog">
    <div class="modal-dialog">
     <!-- Modal content-->
        <div class="modal-content">
		  <div class="modal-header">
			 <button type="button" class="close" data-dismiss="modal">&times;</button>
			 <h4 class="modal-title">VIEW TERBAYAR</h4>
		  </div>
		<div class="modal-body">
			  <div class="table-responsive">
       <table id="formterbayar" class="table  table-striped ">
            
	  <thead>
		<tr>
		  <th>No</th><th></th><th>Nomor Internal User</th><th>Nomor SO</th><th>Judul Pekerjaan</th><th>No Invoice</th>
		  <th>Nominal Pembayaran</th><th>Progress Aktivasi</th><th>Aging</th><th>Masa Berlaku Pekerjaan</th><th>Tahun</th>
		 </tr>
		</thead>
		<tbody>
				<?php 
				
				$tampil=mysql_query("SELECT * FROM view_tbl_keuangan a, view_tbl_teknik b WHERE a.id_teknik=b.id_teknik AND a.aktif='Y' AND a.nominal_pembayaran NOT IN('0','') AND b.tahun='$_GET[act]' ORDER BY a.id_teknik DESC");
				...
				$hasil_tgl=$r[aging];
				$nominal_pembayaran = number_format ($r[nominal_pembayaran], 0, ',', '.');
				$no1++;	
