	  ...
	  <!-- Tampil SO-->
  <div class="modal fade" id="viewselesai" role="dialog">
    <div class="modal-dialog">
     <!-- Modal content-->
        <div class="modal-content">
		  <div class="modal-header">
			 <button type="button" class="close" data-dismiss="modal">&times;</button>
			 <h4 class="modal-title">VIEW SELESAI</h4>
		  </div>
		<div class="modal-body">
			  <div class="table-responsive">
       <table id="formselesai" class="table  table-striped ">
	  ...
	  <thead>
		...
		<tbody>
				...
				$tampil=mysql_query("SELECT * FROM view_tbl_teknik WHERE aktif='Y' AND progress_aktivasi IN('BAPS') AND tahun='$_GET[act]' ORDER BY id_teknik DESC");
				$date1 = date("Y-m-d");
