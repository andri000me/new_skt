     ...
     <!-- Modal content-->
        <div class="modal-content">
		  <div class="modal-header">
			 ...
			 <h4 class="modal-title">VIEW SO</h4>
		  </div>
		<div class="modal-body">
			  <div class="table-responsive">
       <table id="formso" class="table  table-striped ">
            
	  <thead>
		<tr>
		  <th>No</th><th></th><th>Nomor Internal User</th><th>Nomor SO</th><th>Judul Pekerjaan</th><th>Nominal SO</th>
		...
		<tbody>
				...
				$tampil=mysql_query("SELECT * FROM view_tbl_teknik WHERE aktif='Y' AND nominal NOT IN('0','') AND tahun='$_GET[act]' ORDER BY id_teknik DESC");
                ...
                <tr>
				  ...
				  <td width='10px'><span class='label label-success'><i class='fa fa-search' onclick=\"window.open('detail-dashboard-$r[id_teknik].html');\" title='View Data $r[no_so]' target='_blank'></i> </span></td>
