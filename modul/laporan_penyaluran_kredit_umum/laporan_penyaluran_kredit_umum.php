<?php
error_reporting(0);
//include("modul/laporan_penyaluran_kredit_umum/tampil.php");
include("modul/laporan_penyaluran_kredit_umum/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_penyaluran_kredit_umum/tampil.php ',
		 ...
		 $.ajax({
      type: 'GET',
      url: 'modul/laporan_penyaluran_kredit_umum/showcombo.php ',
      data: 'allDate='+ startDate +' sampai '+ endDate, 
        dataType: 'html',
        success: function(response) {
        $('#showcombo').css("display","");
        $('#ftKantorBayar').html(response);
      }
    }),
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_penyaluran_kredit_umum.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN PENYALURAN KREDIT UMUM
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_penyaluran_kredit_umum.php";?>';" >
	...
	<section class="content">
      ...
      <h3 id="showcombo" style="display:none;">
         <select class='form-control select2' style='width: 350px;' name='ftKantorBayar' id='ftKantorBayar' onchange='pilihkantorbayar()'>
         </select>
       </h3>
          <!-- /.box -->
...
function pilihkantorbayar(){
      var startDate = $('#daterange-btn').data('daterangepicker').startDate.format('YYYY-MM-DD');
      var endDate   = $('#daterange-btn').data('daterangepicker').endDate.format('YYYY-MM-DD');
    var kel=$('#ftKantorBayar').val();
  //  console.log(kel);
    $.ajax({
      type: 'GET',
      url: 'modul/laporan_penyaluran_kredit_umum/tampilperkelompok.php ',
