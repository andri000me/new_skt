...
<?php
$header=mysql_query("SELECT b.ftKantorBayar AS ftKantorBayar,a.fdTrans_date FROM txpinjaman_umum_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code = b.ftNoRekening WHERE a.fnStatus <> 9 AND  b.ftKantorBayar !='' AND a.fdTrans_date between '$startDate' AND '$endDate' GROUP BY ftKantorBayar ");
...
c.fcTabAngsuran AS fcTabPelunasan,
