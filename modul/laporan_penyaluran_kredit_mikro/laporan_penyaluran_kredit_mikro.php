<?php 
error_reporting(0);
//include("modul/laporan_penyaluran_kredit_mikro/tampil.php");
include("modul/laporan_penyaluran_kredit_mikro/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_penyaluran_kredit_mikro/tampil.php ',
      ...
      $.ajax({
      type: 'GET',
      url: 'modul/laporan_penyaluran_kredit_mikro/showcombo.php ',
      data: 'allDate='+ startDate +' sampai '+ endDate, 
        dataType: 'html',
        success: function(response) {
	...
	/*
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_penyaluran_kredit_mikro.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN PENYALURAN KREDIT MIKRO <span style="color:red;">*</span>
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_penyaluran_kredit_mikro.php";?>';" >
...
<script>
  ...
  //  console.log(kel);
    $.ajax({
      type: 'GET',
      url: 'modul/laporan_penyaluran_kredit_mikro/tampilperkelompok.php ',
