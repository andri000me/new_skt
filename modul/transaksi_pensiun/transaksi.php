   ...
   ?>
    ...
    <section class="content">
      ...
      <div class="table-responsive">
        ...
        $tampil=mysql_query("SELECT * FROM vdaftarpinjamanpensiun  ORDER BY fnid DESC ");
        }else{
        $tampil=mysql_query("SELECT * FROM vdaftarpinjamanpensiun  ORDER BY fnid DESC");
        }
        $no = $posisi+1;
        ...
        if($r[fnStatus]==1){
          ...
          echo"<td><span class='label label-danger'>Batal</span></td>";  
                  ...
                  echo"<td width='70px' onmouseover=\"this.style.cursor='pointer'\"><span class='label bg-gray disabled color-palette'><i class='fa fa-search' title='View $r[ftTrans_No]' onclick=\"location.href='edit-transaksi-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
          ";
        //  if($_SESSION[leveluser]=='1'){
          echo"<a class='fa fa-trash-o' title='delete $r[ftTrans_No]'  href=javascript:confirmdelete('aksi-delete-transaksi-$r[fnid].html') ></a>";
          // }else{
           //  echo"";
          // }
          echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" autocomplete="off" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-transaksi.html" onSubmit="return validasi(this)">
  <div class="card card-body ">
  <section class="content">
   <div class="box box-info ">
        <div class="box-header with-border">
          <h3 class="box-title">Input Transaksi Pensiun</h3>
      ...
      <div class="form-group has-warning " >
        ...
        //  $tgl_sekarang = date("Y-m-d H:i:s");
          ...
          $query = "SELECT max(fnid) AS last FROM txpinjaman_pensiun_hdr  ";
          ...
          $cariid=mysql_query("SELECT max(ftTrans_No) as notrans FROM txpinjaman_pensiun_hdr");
          ...
          ?>
             ...
             <input type="text" name="ftTrans_No" class="form-control " value=<?php echo "PJP$thn2$bln$unik2"; ?> placeholder="Input ..." id="ftTrans_No" readonly=true>
       ...
       <div class="form-group has-warning" id="tgl_pinjam" >
                ...
                <div class="input-group date ">
                  ...
                  <input type="text" class="form-control pull-right " value=<?php echo "$thn-$bln-$tgl"; ?> name="fdTrans_date" id="fdTrans_date"  onchange="getBulanPensiun(this.value);">
                </div>
                <!-- /.input group -->
              </div>  
    ...
    <div class="col-md-6">
     ...
     <div class="box box-warning">
      ...
      <div class="form-group has-warning" >
                  <label>Bunga [%]</label>
      <?php   
      $p=mysql_fetch_array(mysql_query("SELECT ffBunga FROM tlbiayaadmpensiun WHERE aktif='Y'"));
     ...
     <div class="box box-primary">
        ...
        <?php   
          $p=mysql_fetch_array(mysql_query("SELECT fcAdmAngsuran FROM tlbiayaadmpensiun WHERE aktif='Y'"));
     ...
     <div class="box box-danger">
        ...
        <label>Potongan Adm [%]</label>
                  <?php   
          $p=mysql_fetch_array(mysql_query("SELECT ffAdm FROM tlbiayaadmpensiun WHERE aktif='Y'"));
        ...
        <label>Potongan Provisi [%]</label>
                  <?php   
          $p=mysql_fetch_array(mysql_query("SELECT ffProvisi FROM tlbiayaadmpensiun WHERE aktif='Y'"));
        ...
        <label>Potongan Asuransi [%]</label>
                    <?php   
          $p=mysql_fetch_array(mysql_query("SELECT ffAsuransi FROM tlbiayaadmpensiun WHERE aktif='Y'"));
        ...
        <label>Potongan PPAP [%]</label>
                    <?php   
          $p=mysql_fetch_array(mysql_query("SELECT ffPpap FROM tlbiayaadmpensiun WHERE aktif='Y'"));
        ...
        <label>Materai</label>
                  <?php   
          $p=mysql_fetch_array(mysql_query("SELECT fcMaterai FROM tlbiayaadmpensiun WHERE aktif='Y'"));
        ...
        <label>Pembulatan</label>
                  <input type="text" class="form-control" name="fcPblt" id="fcPblt" placeholder="0" onkeyup="functionSim(this,event)" onkeypress="return isNumberKey(event)"  maxlength=10 >
                </div>
         <div class="form-group">
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT * FROM txpinjaman_pensiun_hdr WHERE fnid='$_GET[fnid]'");
  ...
  echo"
    <form id='myForm' name='myForm' method='POST' enctype='multipart/form-data' action='aksi-edit-transaksi.html' >
 <div id='printr'>
 <section class='content'>
   <div class='box box-info'>
        <div class='box-header with-border'>
    ...
    echo" <div class='form-group has-success' >
     ...
     <div class='box box-primary'>
      ...
      $tampil3=mysql_query("SELECT ftLoan_No,fcPlafond,fcPokokAngsuran,fcBunganAngsuran,fcAdmAngsuran,fcPbltAngsuran,fcTotalAngsuran FROM txangsuran_pensiun_hdr WHERE ftLoan_No='$r[ftTrans_No]'   ");
