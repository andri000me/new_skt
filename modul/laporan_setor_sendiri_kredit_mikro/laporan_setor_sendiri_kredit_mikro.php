<?php
error_reporting(0);
//include("modul/laporan_setor_sendiri_kredit_mikro/tampil.php");
include("modul/laporan_setor_sendiri_kredit_mikro/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_setor_sendiri_kredit_mikro/tampil.php ',
		...
		$.ajax({
      type: 'GET',
      url: 'modul/laporan_setor_sendiri_kredit_mikro/showcombo.php ',
      data: 'allDate='+ startDate +' sampai '+ endDate, 
        dataType: 'html',
        success: function(response) {
        $('#showcombo').css("display","");
        $('#ftkelompok').html(response);
      }
    }),
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_setor_sendiri_kredit_mikro.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN SETOR SENDIRI KREDIT MIKRO <span style="color:red;">*</span>
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_setor_sendiri_kredit_mikro.php";?>';" >
	...
	<section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
          <h3 id="showcombo" style="display:none;">
         <select class='form-control select2' style='width: 350px;' name='ftkelompok' id='ftkelompok' onchange='pilihkelompok()'>
         </select>
       </h3>
...
<script>
  ...
  function pilihkelompok(){
      var startDate = $('#daterange-btn').data('daterangepicker').startDate.format('YYYY-MM-DD');
      var endDate   = $('#daterange-btn').data('daterangepicker').endDate.format('YYYY-MM-DD');
    var kel=$('#ftkelompok').val();
    console.log(kel);
    $.ajax({
      type: 'GET',
      url: 'modul/laporan_setor_sendiri_kredit_mikro/tampilperkelompok.php ',
