<?php
error_reporting(0);
//include("modul/laporan_daftar_nominatif_umum/tampil.php");
include("modul/laporan_daftar_nominatif_umum/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
		 ...
		 $.ajax({
      type: 'GET',
      url: 'modul/laporan_daftar_nominatif_umum/showcombo.php ',
      data: 'allDate='+ startDate +' sampai '+ endDate, 
        dataType: 'html',
        success: function(response) {
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_daftar_nominatif_umum.php?first='+awal+'&last='+akhir,
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_daftar_nominatif_umum.php";?>';" >
...
function pilihkantorbayar(){
  ...
  //  console.log(kel);
    $.ajax({
      type: 'GET',
      url: 'modul/laporan_daftar_nominatif_umum/tampilperkelompok.php ',
