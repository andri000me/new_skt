<?php
error_reporting(0);
//include("modul/laporan_daftar_tagihan_umum/tampil.php");
include("modul/laporan_daftar_tagihan_umum/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_daftar_tagihan_umum/tampil.php ',
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_daftar_tagihan_umum.php?first='+awal+'&last='+akhir,
