	  ...
	  <thead>
		...
		<tbody>
				...
				$tampil=mysql_query("SELECT a.*, b.fcPokokAngsuran, b.fcBunganAngsuran, b.fcAdmAngsuran, b.fcPbltAngsuran, b.fcTabAngsuran,b.fcPokokAngsuran + b.fcBunganAngsuran + b.fcAdmAngsuran + b.fcPbltAngsuran + b.fcTabAngsuran AS fcTotalAngsuran,
					b.fcplafond, b.ffbunga, b.fnJW, c.ftAlamat, c.ftNamaKelompok,c.ftNamaNasabah,c.ftNoRekening, b.fdTrans_date
					FROM (
				...
				echo"
                <tr bgcolor='#d5e8e4' onmouseover=\"bgColor='#FFFF9E'\" onmouseout=\"bgColor='#d5e8e4'\" onclick=\"pick('$no2','$no3','$no4','$no5','$no6','$no7','$no8','$no9','$no10','$no11','$no12','$no13','$no14','$no15','$no16','$no17')\">
				  <td>$no1</td>
				  <td>$r[ftTrans_No]</td>   
