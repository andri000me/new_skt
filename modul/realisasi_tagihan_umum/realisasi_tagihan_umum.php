        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1' || $_SESSION[leveluser]=='2'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-realisasi-tagihan-umum.html ";?>';" value="Tambah" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
			...
			<div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM TXRealisasi_Tagihan_Umum_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC  ");
				}else{
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM TXRealisasi_Tagihan_Umum_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC ");
				}
				$no = $posisi+1;
				...
				echo"				 				  
                  <td width='70px' onmouseover=\"this.style.cursor='pointer'\"><span class='label bg-gray disabled color-palette'><i class='fa fa-search' title='Edit $r[ftTrans_No]' onclick=\"location.href='edit-realisasi-tagihan-umum-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
				  ";
				 // if($_SESSION[leveluser]=='1'){
				  echo"<a class='fa fa-trash-o' title='delete $r[ftNamaNasabah]'  href=javascript:confirmdelete('aksi-delete-realisasi-tagihan-umum-$r[fnid].html') ></a>";
				  // }else{
					 //  echo"";
				  // }
				  echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" autocomplete="off" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-realisasi-tagihan-umum.html" onSubmit="return validasi(this)">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Input Realisasi Tagihan Umum</h3>
          ...
          <div class="row">
			...
			<div class="form-group has-warning" >
				...
				//	$tgl_sekarang = date("Y-m-d H:i:s");
					...
					$query = "SELECT max(fnid) AS last FROM TXRealisasi_Tagihan_Umum_Hdr  ";
					...
					$cariid=mysql_query("SELECT max(ftTrans_No) as notrans FROM TXRealisasi_Tagihan_Umum_Hdr");
					...
					?>
					<input type="text" name="ftTrans_No" class="form-control " value=<?php echo "AU$thn2$bln$unik2"; ?> placeholder="Input ..." id="ftTrans_No" readonly=true>
			...
			<div class="form-group has-warning" >
				  ...
				  <textarea class="form-control" rows="5" placeholder="Enter ..." name="ftNotes" ></textarea>
             </div>
		  ...
		  <div class="box box-success">
			...
			<!--  <div class="form-group has-success" >
			 ...
			 <div class="input-group">
              <input type="text" class="form-control" name="ftLoan_No" id="ftLoan_No"  placeholder="Input ..." readonly=true required="">
                <span class="input-group-addon "><a href="#" class="small-box-footer " onClick="showPinjamanumum('rikues')"><b>SEARCH</b></a></span>
              </div></div> -->

               <div class="form-group has-success">
		          <label> No Pinjaman&nbsp;&nbsp;&nbsp;<span style="color:red;">*</span></label>
		          <div class="input-group">
		            <input type="text" class="form-control" id="ftLoan_No" placeholder="Input ..." aria-describedby="basic-addon1" name="ftLoan_No" readonly required="">
		           <span class="input-group-addon" id="basic-addon1" onmouseover="this.style.cursor='pointer'" 
		            onClick="showPinjamanumum('rikues')"><span class='glyphicon glyphicon-new-window' aria-hidden='true'></span></span>
		          </div>
		        </div>
     ...
     <!-- /.box-header -->
	    ...
	    <div class="row">
		 ...
		 <div class="box-footer">
                <a  class="btn btn-default" href="realisasi-tagihan-umum.html">Cancel</a>
             </div>	
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat FROM TXRealisasi_Tagihan_Umum_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening WHERE a.fnid='$_GET[fnid]'");
...
?>	
  <form id="myForm" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-edit-realisasi-tagihan-umum.html" onSubmit="return validasi(this)">
  <div id="printr">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
        ...
        <div class="box-body" >
          ...
          <div class="row">
			...
			<div class="form-group has-warning" >
                  <!-- <label>Saldo Simpanan</label> -->
                  <input type="hidden" name="fcSimpanan" class="form-control" placeholder="Input ..." id="fcSimpanan" value=<?php echo "$saldosimpanan"; ?> readonly=true>
			  </div>
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
			...
			<div class="form-group has-warning" >
                  <label>Keterangan</label>
				  <textarea class="form-control" rows="5" placeholder="Enter ..." name="ftNotes" readonly=true><?php echo "$r[ftNotes]"; ?> </textarea>
             </div>
