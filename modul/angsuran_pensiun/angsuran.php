        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1' || $_SESSION[leveluser]=='2'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-angsuran-pensiun.html ";?>';" value="Tambah" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
			...
			<div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM txangsuran_pensiun_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC  ");
				}else{
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM txangsuran_pensiun_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC ");
				}
				$no = $posisi+1;
				...
				echo"				 				  
                  <td width='70px'><span class='label bg-gray disabled color-palette' onmouseover=\"this.style.cursor='pointer'\"><i class='fa fa-search' title='Edit $r[ftTrans_No]' onclick=\"location.href='edit-angsuran-pensiun-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
				  ";
				//  if($_SESSION[leveluser]=='1'){
				  echo"<a class='fa fa-trash-o' title='delete $r[ftNamaNasabah]'  href=javascript:confirmdelete('aksi-delete-angsuran-pensiun-$r[fnid].html') ></a>";
				  // }else{
					 //  echo"";
				  // }
				  echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" autocomplete="off" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-angsuran-pensiun.html" onSubmit="return validasi(this)">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Input Angsuran Pensiun</h3>
        ...
        <div class="box-body" >
          ...
          <div class="row">
			...
			<script>
				  function getAngsuranBulanPensiun(x) {
			 ...
			 <div class="form-group has-warning" id="tgl_pinsjam" >
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value=<?php echo "$thn-$bln-$tgl"; ?> name="fdTrans_date" id="fdTrans_date" onchange="getAngsuranBulanPensiun(this.value);">
                </div>
                <!-- /.input group -->
              </div> 	
			...
			<!--  <div class="form-group has-success" >
			 ...
			 <div class="input-group">
              <input type="text" class="form-control" name="ftLoan_No" id="ftLoan_No"  placeholder="Input ..." readonly=true required="">
                <span class="input-group-addon "><a href="#" class="small-box-footer " onClick="showPinjamanpensiun('rikues')"><b>SEARCH</b></a></span>
              </div></div> -->

              <div class="form-group has-success">
            <label>No Pinjaman&nbsp;&nbsp;&nbsp;<span style="color:red;">*</span></label>
              <div class="input-group">
                 <input type="text" class="form-control" id="ftLoan_No" placeholder="Input ..." aria-describedby="basic-addon1" name="ftLoan_No" readonly>
             <span class="input-group-addon" id="basic-addon1" onmouseover="this.style.cursor='pointer'" 
              onClick="showPinjamanpensiun('rikues')"><span class='glyphicon glyphicon-new-window' aria-hidden='true'></span></span>
            </div>
          </div> 
            ...
            <div class="box-body">
               ...
               <div class="form-group" id="divisi2">
                ...
                <select class="form-control select2" style="width: 100%;" name="fnPaymentMethod" id="fnPaymentMethod" readonly=true>
                  ...
                  <option selected="selected" value="0">SETOR SENDIRI</option>
                </select>
              </div>
     ...
     <!-- /.box-header -->
	    ...
	    <div class="row">
		 ...
		 <div class="box-footer">
                <a  class="btn btn-default" href="angsuran-pensiun.html">Cancel</a>
             </div>	
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat FROM txangsuran_pensiun_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening WHERE a.fnid='$_GET[fnid]'");
...
?>	
  <form id="myForm" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-edit-angsuran-pensiun.html" onSubmit="return validasi(this)">
  <div id="printr">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
