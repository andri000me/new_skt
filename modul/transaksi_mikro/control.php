...
function showSouvenir(menu) {
	var v= $( '#ftKodeKelompok' ).val();
	// console.log(v);
    sList = window.open('modul/transaksi_mikro/formsearch.php?x='+v, 'Print', 'width=920,height=420,scrollbars=yes');
	}
</script>
...
// Rubah ke format currency
	...
	//=================================================================	
		...
		trmbersih=x-admhasil-asrhasil-conv_mtr;// Menghitung terima bersih dari plafond pinjaman - Potongan Adm - Potongan Asuransi - Materai
	...
	//=================================================================	
		totalp =   x - admhasil - asrhasil-conv_mtr- pbltp4-conv_pel;// Hitung total terima bersih	(plafond pinjaman - Potongan Adm - Potongan Asuransi - Materai - selisih pembulatan - Pelunasan )
	//=================================================================		
	...
	//=================================================================		
		selisihsl =Math.floor(totalp) - hasil; // Pembulatan (selisih )
	...
	//=================================================================	
		...
		conv_asrhasil=asrhasil.formatMoney();//convert Potongan Asuransi ke currency
		trmbersih=conv_x-admhasil-asrhasil-conv_mtr-conv_pblt;// Menghitung terima bersih dari plafond pinjaman - Potongan Adm - Potongan Asuransi - Materai
		trmbersih2 =  Math.floor(trmbersih);// Pembulatan ke bawah Terima Bersih
	//=================================================================		
		// Cari selisih pembulatan terima bersih
		pbltp =  trmbersih2/100;//
		...
		pbltp4 =  pbltp3-trmbersih2;
	//=================================================================	
		totalp =   conv_x - (-conv_dis) - admhasil - asrhasil-conv_mtr-conv_pblt- pbltp4-conv_pel-conv_sim;// Hitung total terima bersih	(plafond pinjaman - Potongan Adm - Potongan Asuransi - Materai - selisih pembulatan - Pelunasan )
	//=================================================================		
		// pembulatan kebawah total terima bersih
		 hasil = (Math.floor(parseInt(totalp))%parseInt(100) == 0)? Math.floor(parseInt(totalp)) : Math.floor((parseInt(totalp)+parseInt(100)/2)/parseInt(100))*parseInt(100);
		conv_totalp=hasil.formatMoney();//convert total terima bersih ke currency
