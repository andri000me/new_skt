...
function validasi(form){
  if (form.nama_menu.value == ""){
   sweetAlert("Oops...", "Nama Group Menu harus di isi!", "error");
...
$aksi="modul/group_menu/aksi_group_menu.php";
switch($_GET[act]){
  // Tampil Hubungi Kami
  default:
   ?>
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-group-menu.html ";?>';" value="Tambah Group Menu" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          echo"
               <td width='70px' onmouseover=\"this.style.cursor='pointer'\"> $show &nbsp;&nbsp;&nbsp; <i class='fa fa-edit' title='edit $r[nama_menu]' onclick=\"location.href='edit-group-menu-$r[id_main].html';\"></i> &nbsp;&nbsp;&nbsp;";
				 /* if($_SESSION[leveluser]=='1'){*/
				  echo"<a class='fa fa-trash-o' title='delete $r[id_main]'  href=javascript:confirmdelete('$aksi?module=group_menu&act=hapus&id_main=$r[id_main]') ></a>";
				  /*}else{
					  echo"";
				  }*/
				  echo"</td>
 ...
 case "tambah":
  ?>
   <div class="box box-default">
		...
		<form id="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-group-menu.html" onSubmit="return validasi(this)">
        <!-- /.box-header -->
        <div class="box-body" id="myForm">
          ...
          <div class="row">
			...
			<div class="form-group" id="no_so22">
                  <label>Nama Group Menu<span style='color:red;'>*</span></label>
                  <input type="text" name="nama_menu" class="form-control" placeholder="Nama Group Menu" id="nama_menu">
      ...
      <div class="form-group">
        ...
        <!-- /.box-body -->
              <div class="box-footer">
                <a  class="btn btn-default" href="group-menu.html">Cancel</a>
...
//    $str .= "<input type=checkbox name='".$key."[]' value='$w[$key]' $_ck>$w[$Label] ";
  ...
  return $str;
   ...
   $edit = mysql_query("SELECT * FROM mainmenu WHERE id_main='$_GET[id_main]'");
  ...
  <div class='box box-default'>
		...
		echo"<form id='form' method='POST'  enctype='multipart/form-data' action='aksi-edit-group-menu.html' >
        <!-- /.box-header -->
        ...
        <div class='box-body'>
          ...
          <div class='row'>
			...
			<div class='form-group' id='username'>
                  <label>Nama Group Menu<span style='color:red;'>*</span></label>
                  <input type='hidden' name='id_main'  value='$r[id_main]' >
                  <input type='text' name='nama_menu' id='nama_menu' value='$r[nama_menu]' class='form-control' placeholder='Nama Group Menu' >
                </div>
    ...
    <option value='fa-youtube-square'>&#xf166; fa-youtube-square</option>
      ...
      <div class='form-group'>
                  <label>Link</label>
                  <input type='text' name='link' id='link' value='$r[link]' class='form-control' placeholder='Link'>
                </div>
      <div class='form-group'>
                  <label>Urutan</label>
