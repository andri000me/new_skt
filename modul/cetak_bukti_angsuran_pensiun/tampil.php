...
INNER JOIN txpinjaman_pensiun_hdr d ON a.ftTrans_no = d.`ftTrans_No` AND a.`ftCustomer_Code` = d.`ftCustomer_Code`
CROSS JOIN tscompany_info c ON c.aktif = 'Y'
CROSS JOIN tljabatan e 
WHERE b.`ftKantorBayar` = '$kelompok'
...
<tbody>
  ...
  <tr>
    <td colspan='12'><div align='center'><strong>$kelompok ( PENSIUN ) </strong></div></td>
  </tr>
  <tr>
