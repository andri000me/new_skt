<?php
error_reporting(0);
include("modul/cetak_bukti_angsuran_pensiun/form_tgl.php");
$tgl = date("d");
$bln = date("m");
$thn = date("Y");
?> 
...
$(function () {
 ...
 var endDate;
	...
	//		console.log(endDate);			
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_cetak_bukti_angsuran_pensiun.php?first='+awal+'&last='+akhir,
...
function showKantorbayar(menu) {
  sList = window.open('modul/cetak_bukti_angsuran_pensiun/kelompok.php', 'Print', 'width=920,height=420,scrollbars=yes');
  }
    ...
    <div class="box-body layout-top-nav">
      ...
      <header class="main-header">
        <nav class="navbar navbar-static-top">
          ...
          <a href="#" class="small-box-footer" onmouseover="this.style.cursor='pointer'" onClick="showKantorbayar('rikues');">
              <span id="kelom" >
      ...
      <li><h3 class="box-title">
          <input type="text" class="btn bg-purple dropdown-toggle" value=<?php echo "$thn-$bln-$tgl"; ?>  name="fdTrans_date" id="fdTrans_date" value="Pilih Tanggal" readonly=true onchange="act_tgl()">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_cetak_bukti_angsuran_pensiun.php";?>';" >
...
if (kel=="Pilih Kantor Bayar"){
      ...
      $.ajax({
      type: 'GET',
      url: 'modul/cetak_bukti_angsuran_pensiun/tampil.php ',
