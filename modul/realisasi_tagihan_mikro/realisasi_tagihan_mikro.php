        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1' || $_SESSION[leveluser]=='4'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-realisasi-tagihan-mikro.html ";?>';" value="Tambah" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
			...
			<div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  <th>No</th>
                  <th>No Realisasi Tagihan</th>
                  <th>Tgl Realisasi Tagihan</th>
				  <th>Nama Nasabah</th>
				  <th>No Rekening</th>
				...
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM TXRealisasi_Tagihan_Mikro_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC  ");
				}else{
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM TXRealisasi_Tagihan_Mikro_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC ");
				}
				$no = $posisi+1;
                ...
                <tr>
				  ...
				  <td>$jumlahbayar</td>";
				  //Metode
				  if($r[fnPaymentMethod]==0){
                  echo"<td>TAGIHAN</td>"; 
				  }else{
					echo"<td>Error 404</td>";  
				  }
				 //Status
				if($r[fnStatus]==1){
				...
				echo"				 				  
                  <td width='70px' onmouseover=\"this.style.cursor='pointer'\"><span class='label bg-gray disabled color-palette'><i class='fa fa-search' title='Edit $r[ftTrans_No]' onclick=\"location.href='edit-realisasi-tagihan-mikro-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
				  ";
				 // if($_SESSION[leveluser]=='1'){
				  echo"<a class='fa fa-trash-o' title='delete $r[ftNamaNasabah]'  href=javascript:confirmdelete('aksi-delete-realisasi-tagihan-mikro-$r[fnid].html') ></a>";
				  // }else{
					 //  echo"";
				  // }
				  echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" autocomplete="off" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-realisasi-tagihan-mikro.html" onSubmit="return validasi(this)">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Input Realisasi Tagihan Mikro</h3>
          ...
          <div class="row">
			...
			<div class="form-group has-warning" >
				...
				//	$tgl_sekarang = date("Y-m-d H:i:s");
					...
					$query = "SELECT max(fnid) AS last FROM TXRealisasi_Tagihan_Mikro_Hdr  ";
					...
					$cariid=mysql_query("SELECT max(ftTrans_No) as notrans FROM TXRealisasi_Tagihan_Mikro_Hdr");
			 ...
			 <div class="form-group has-warning" id="tgl_pinsjam" >
                <label>Tgl Realisasi Tagihan</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text" class="form-control pull-right"  value=<?php echo "$thn-$bln-$tgl"; ?> name="fdTrans_date" id="fdTrans_date">
                </div>
                <!-- /.input group -->
              </div> 	
			...
			<div class="form-group has-warning" >
                  ...
                  <input type="hidden" name="fcSimpanan" class="form-control" placeholder="Input ..." id="fcSimpanan" readonly=true>
			  </div>
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
			...
			<div class="form-group has-warning" >
				  ...
				  <textarea class="form-control" rows="1" placeholder="Enter ..." name="ftNotes"></textarea>
             </div>
			<div class="form-group has-warning">
                  <label>Status Absen</label>
          <select class="form-control select2" style="width: 100%;" name="ftStatus_Absen" id="ftStatus_Absen">
          <option value="" selected>Pilih</option>
          <option value="Hadir dan Bayar" >Hadir dan Bayar</option>
          <option value="Tidak Hadir Bayar" >Tidak Hadir Bayar</option>
          <option value="Hadir DiTanggung Renteng" >Hadir DiTanggung Renteng</option>
          <option value="Tidak Hadir dan DiTanggung Renteng" >Tidak Hadir dan DiTanggung Renteng</option>
          </select>
		...
		<div class="col-md-6">
           ...
           <!-- <div class="form-group has-success" >
                  ...
                  <input type="text" name="ftCustomer_Code" id="ftCustomer_Code" class="form-control" value="" placeholder="Input ..." readonly=true>
			 </div> -->
          ...
          <div class="input-group">
           ...
           <span class="input-group-addon" id="basic-addon1" onmouseover="this.style.cursor='pointer'" 
			...
			<div class="form-group has-success" >
			 ...
			 <!-- <div class="form-group has-success" >
                  <label>Alamat</label>
				  <textarea class="form-control" rows="6" placeholder="" name="ftAlamat" id="ftAlamat" readonly=true></textarea> -->
		 ...
		 <div class="box box-danger">
            <div class="box-body">
               ...
               <div class="form-group" id="divisi2">
                ...
                <!-- <input type="text" class="form-control" placeholder="SETOR SENDIRI" name="fnPaymentMethod" id="fnPaymentMethod" value="0" readonly=true> -->
                <select class="form-control select2" style="width: 100%;" name="fnPaymentMethod" id="fnPaymentMethod" readonly=true>
                  <option selected="selected" value="0">TAGIHAN</option>
				  </select>
              </div>
               
			   <div class="form-group">
				<label>Pokok</label>
                  <input type="text" class="form-control" placeholder="Input ..." name="fcPokokAngsuran" readonly=true>
                </div>
			  
			     <div class="form-group">
				<label>Bunga</label>
                  <input type="text" class="form-control" placeholder="Input ..." name="fcBunganAngsuran" readonly=true>
                </div>
			  
			   <div class="form-group">
				<label>Adm</label>
                  <input type="text" class="form-control" placeholder="Input ..." name="fcAdmAngsuran" readonly=true>
                </div>
				 <div class="form-group">
				<label>Pblt</label>
                  <input type="text" class="form-control" placeholder="Input ..."  name="fcPbltAngsuran" readonly=true>
                </div>
				 <div class="form-group">
				<label>Tabungan</label>
                  <input type="text" class="form-control" placeholder="Input ..."  name="fcTabAngsuran" readonly=true>
                </div>
				 <div class="form-group">
				<label>Jumlah</label>
     ...
     <!-- /.box-header -->
	    ...
	    <div class="row">
		 ...
		 <div class="box-footer">
                <a  class="btn btn-default" href="realisasi-tagihan-mikro.html">Cancel</a>
             </div>	
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat,b.ftNamaKelompok FROM TXRealisasi_Tagihan_Mikro_Hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening WHERE a.fnid='$_GET[fnid]'");
...
?>	
  <form id="myForm" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-edit-realisasi-tagihan-mikro.html" onSubmit="return validasi(this)">
  <div id="printr">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
        ...
        <div class="box-body" >
          ...
          <div class="row">
			...
			<div class="form-group has-warning" >
                  <label>Keterangan</label>
				  <textarea class="form-control" rows="1" placeholder="Enter ..." name="ftNotes" readonly=true><?php echo "$r[ftNotes]"; ?> </textarea>
             </div>
			<div class="form-group has-warning" >
                  <label>Status Absen</label>
				  <input type="text" name="ftStatus_Absen" readonly=true id="ftStatus_Absen" class="form-control"  value="<?php echo $r['ftStatus_Absen']; ?>" >
             </div>
            <!-- /.END RIGHT SIDE -->
            </div>
            <!-- /.col -->
		...
		<div class="col-md-6">
           ...
           <div class="form-group has-success" >
			...
			<div class="form-group has-success" >
			 ...
			 <!-- <div class="form-group has-success" >
                  <label>Alamat</label>
				  <textarea class="form-control" rows="6" placeholder="" name="ftAlamat" id="ftAlamat" readonly=true><?php echo "$r[ftAlamat]"; ?></textarea> -->
				<!--  <input type="text" name="ftAlamat" id="ftAlamat" class="form-control" value="" placeholder="Input ..." > -->
