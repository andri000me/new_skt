...
// Hapus realisasi-tagihan-mikro
if ($module=='realisasi_tagihan_mikro' AND $act=='delete'){
  mysql_query("DELETE FROM TXRealisasi_Tagihan_Mikro_Hdr WHERE fnid='$_GET[fnid]'");
  header('location:realisasi-tagihan-mikro.html');
}

// Input realisasi-tagihan-mikro
elseif ($module=='realisasi_tagihan_mikro' AND $act=='input'){
 
	  mysql_query("INSERT INTO TXRealisasi_Tagihan_Mikro_Hdr(		ftTrans_No,
	  														ftBranch_Code,
															fdTrans_date,
															fcSimpanan,
															ftNotes,
	 ...
	 /* mysql_query("UPDATE txpinjaman_mikro_nasabah_hdr set fcOutstanding = fcOutstanding - '$fcPokokAngsuran' where ftTrans_No='$_POST[ftLoan_No]' and ftCustomer_Code='$_POST[ftCustomer_Code]'");
*/
  header('location:realisasi-tagihan-mikro.html'); 

}

// update realisasi-tagihan-mikro
elseif ($module=='realisasi_tagihan_mikro' AND $act=='update'){
 
	  mysql_query("UPDATE TXRealisasi_Tagihan_Mikro_Hdr SET		fnStatus		= '99',
