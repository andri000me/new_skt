    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-pinjaman-pensiun.html ";?>';" value="Tambah" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
          ...
          <th style="color:#4375c6;">Provisi</th>
          <th style="color:#4375c6;">Asuransi</th>
          <th style="color:#4375c6;">PPAP</th>
          ...
          <th style="color:#4375c6;">Aktif</th>
				...
				if($_SESSION[leveluser]=='1'){
				$tampil=mysql_query("SELECT * FROM tlbiayaadmpensiun  ORDER BY fnid ");
				}else{
				$tampil=mysql_query("SELECT * FROM tlbiayaadmpensiun  ORDER BY fnid ");
				}
				$no = $posisi+1;
        ...
        $fcAdmAngsuran = number_format ($r[fcAdmAngsuran], 0, ',', ',');
          ...
          <td style='color:#4375c6;'>$r[ffProvisi] %</td> 
          <td style='color:#4375c6;'>$r[ffAsuransi] %</td> 
          <td style='color:#4375c6;'>$r[ffPpap] %</td> 
          <td style='color:#4375c6;'>$fcMaterai</td>
          <td style='color:#4375c6;'>$fcAdmAngsuran</td>
          <td style='color:#4375c6;'>$r[aktif]</td>
          <td width='70px' onmouseover=\"this.style.cursor='pointer'\"><span class='label bg-gray disabled color-palette'><i class='fa fa-check-square-o' title='Aktifkan $r[fnid]' onclick=\"location.href='aktif-pinjaman-pensiun-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
				  <i class='fa fa-edit' title='edit $r[fnid]' onclick=\"location.href='edit-pinjaman-pensiun-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;
				  ";
				//  if($_SESSION[leveluser]=='1'){
				  echo"<a class='fa fa-trash-o' title='delete $r[fnid]'  href=javascript:confirmdelete('aksi-delete-pinjaman-pensiun-$r[fnid].html') ></a>";
				  // }else{
					 //  echo"";
				  // }
				  echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-pinjaman-pensiun.html" onSubmit="return validasi(this)">
		...
		<div class="col-md-6">
		 <div class="box-header with-border">
          <h3 class="box-title">Input Pinjaman Pensiun</h3>
        </div>
      ...
      <div class="form-group has-success">
                  <label>Provisi (%)<span style="color:red;">*</span></label>
                  <input type="text" name="ffProvisi" id="ffProvisi" class="form-control" placeholder="Input ..." onkeyup='jwfunction(this,event)' onkeypress='return isNumberKey(event)' maxlength='5'>
                </div>          
      ...
      <div class="form-group has-success">
                  <label>PPAP (%)<span style="color:red;">*</span></label>
                  <input type="text" name="ffPpap" id="ffPpap" class="form-control" placeholder="Input ..." onkeyup='jwfunction(this,event)' onkeypress='return isNumberKey(event)' maxlength='5'>
                </div>
      ...
      <div class="form-group has-success" >
			 ...
			 <div class="box-footer">
                <a  class="btn btn-default" href="pinjaman-pensiun.html">Cancel</a>
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT * FROM tlbiayaadmpensiun WHERE fnid='$_GET[fnid]'");
   $r    = mysql_fetch_array($edit);
   $fcMaterai = number_format ($r[fcMaterai], 0, ',', ',');
   $fcAdmAngsuran = number_format ($r[fcAdmAngsuran], 0, ',', ',');
  echo"
  <form id='myForm' method='POST' enctype='multipart/form-data' action='aksi-edit-pinjaman-pensiun.html' onSubmit='return validasi(this)'>
  
     <div class='box-body' >
		  
		<div class='col-md-6'>
		 <div class='box-header with-border'>
          <h3 class='box-title'>Edit Pinjaman Pensiun</h3>
        </div>
		 <div class='box box-success'>
           <div class='box-body '>
			<div class='form-group has-success' >
      ...
      <div class='form-group has-success'>
                  <label>Provisi (%)<span style='color:red;''>*</span></label>
                  <input type='text' name='ffProvisi' id='ffProvisi' value='$r[ffProvisi]' class='form-control' placeholder='Input ...' onkeyup='jwfunction(this,event)' onkeypress='return isNumberKey(event)' maxlength='5'>
                </div>
      ...
      <div class='form-group has-success'>
                  <label>PPAP (%)<span style='color:red;''>*</span></label>
                  <input type='text' name='ffPpap' id='ffPpap' value='$r[ffPpap]' class='form-control' placeholder='Input ...' onkeyup='jwfunction(this,event)' onkeypress='return isNumberKey(event)' maxlength='5'>
                </div>    
