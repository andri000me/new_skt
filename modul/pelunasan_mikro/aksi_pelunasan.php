...
// Hapus pelunasan_mikro
if ($module=='pelunasan_mikro' AND $act=='delete'){
  mysql_query("DELETE FROM txpelunasan_mikro_hdr WHERE fnid='$_GET[fnid]'");
  header('location:pelunasan-mikro.html');
}

// Input pelunasan_mikro
elseif ($module=='pelunasan_mikro' AND $act=='input'){
 
	  mysql_query("INSERT INTO txpelunasan_mikro_hdr(		ftTrans_No,
	  														ftBranch_Code,
															fdTrans_date,
															fcSimpanan,
															ftNotes,
...
// update pelunasan_mikro
elseif ($module=='pelunasan_mikro' AND $act=='update'){
 
	  mysql_query("UPDATE txpelunasan_mikro_hdr SET		fnStatus		= '99',
