<?php
error_reporting(0);
include("modul/cetak_form_terima_bagi_hasil_mikro/form_tgl.php");
$tgl = date("d");
$bln = date("m");
$thn = date("Y");
?> 
...
$(function () {
 ...
 var endDate;
	...
	//		console.log(endDate);			
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_cetak_form_terima_bagi_hasil_mikro.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       CETAK FORM TERIMA BAGI HASIL MIKRO
      ...
      <li><h3 class="box-title">
          <input type="text" class="btn bg-purple dropdown-toggle" value=<?php echo "$thn-$bln-$tgl"; ?>  name="fdTrans_date" id="fdTrans_date" value="Pilih Tanggal" readonly=true onchange="act_tgl()">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_cetak_form_terima_bagi_hasil_mikro.php";?>';" >
...
if (kel=="Pilih Kelompok"){
      ...
      $.ajax({
      type: 'GET',
      url: 'modul/cetak_form_terima_bagi_hasil_mikro/tampil.php ',
