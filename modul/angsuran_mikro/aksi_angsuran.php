...
// Hapus angsuran-mikro
if ($module=='angsuran_mikro' AND $act=='delete'){
  mysql_query("DELETE FROM txangsuran_mikro_hdr WHERE fnid='$_GET[fnid]'");
  header('location:angsuran-mikro.html');
}

// Input angsuran-mikro
elseif ($module=='angsuran_mikro' AND $act=='input'){
 
	  mysql_query("INSERT INTO txangsuran_mikro_hdr(		ftTrans_No,
	  														ftBranch_Code,
															fdTrans_date,
															fcSimpanan,
															ftNotes,
...
// update angsuran-mikro
elseif ($module=='angsuran_mikro' AND $act=='update'){
 
	  mysql_query("UPDATE txangsuran_mikro_hdr SET		fnStatus		= '99',
