...
function showSouvenir(menu) {
	sList = window.open('modul/transaksi_umum/formsearch.php', 'Print', 'width=920,height=420,scrollbars=yes');
	}
</script>
...
<script >
	...
	//=================================================================		
		...
		pbltp4 =  pbltp3-trmbersih2;
	//=================================================================	
		totalp =   conv_x - (-conv_dis) - admhasil - asrhasil-provisihasil-ppaphasil-conv_mtr-conv_rrp-conv_pblt- pbltp4-conv_pel-conv_sim;// Hitung total terima bersih	(plafond pinjaman - Potongan Adm - Potongan Asuransi - Potongan Provisi - Potongan PPAP - Materai - selisih pembulatan - Pelunasan )
	//=================================================================		
		// pembulatan kebawah total terima bersih
		 hasil = (Math.floor(parseInt(totalp))%parseInt(100) == 0)? Math.floor(parseInt(totalp)) : Math.floor((parseInt(totalp)+parseInt(100)/2)/parseInt(100))*parseInt(100);
		conv_totalp=hasil.formatMoney();//convert total terima bersih ke currency
