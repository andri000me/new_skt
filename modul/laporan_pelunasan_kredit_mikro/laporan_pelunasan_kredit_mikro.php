<?php
error_reporting(0);
//include("modul/laporan_pelunasan_kredit_mikro/tampil.php");
include("modul/laporan_pelunasan_kredit_mikro/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_pelunasan_kredit_mikro/tampil.php ',
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_pelunasan_kredit_mikro.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN PELUNASAN KREDIT MIKRO
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_pelunasan_kredit_mikro.php";?>';" >
