...
if($kelompok !="all"){
    $header=mysql_query("SELECT  a.fdTrans_date, b.ftNamaKelompok AS ftkelompok,b.ftKantorBayar AS ftKantorBayar FROM txangsuran_umum_hdr a
        LEFT JOIN tlnasabah b ON a.ftCustomer_Code = b.ftNoRekening WHERE b.ftKantorBayar='$kelompok' AND a.fdTrans_date between '$startDate' AND '$endDate' GROUP BY ftKantorBayar ");
            $w=mysql_fetch_array($header);
            $e=$w[fdTrans_date];
  $temp2 ="<center><b>LAPORAN SETOR SENDIRI KREDIT UMUM<br>TANGGAL : $e<br>Kantor Bayar :$kelompok";
...
//$tampil=mysql_query("SELECT * FROM txpinjaman_mikro_hdr WHERE fdTrans_date between '$startDate' AND '$endDate'");
    $tampil=mysql_query("SELECT a.ftCustomer_Code , a.fdTrans_date, b.ftNamaNasabah, b.ftSubCabang AS ftwilayah, b.ftNamaKelompok AS ftkelompok,b.ftKantorBayar AS ftKantorBayar,
                        ...
                        WHERE b.ftKantorBayar='$kelompok' AND a.fdTrans_date between '$startDate' AND '$endDate'
              ");
    $no1 = 0;
...
";    
 ...
 $temp ="<center><b>LAPORAN SETOR SENDIRI KREDIT UMUM<br>TANGGAL : $e<br>Kantor Bayar :$d";
