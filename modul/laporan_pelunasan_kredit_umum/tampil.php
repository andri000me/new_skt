...
<center ><b>LAPORAN PELUNASAN KREDIT UMUM <?php echo "$startDate sampai $endDate" ?> </b></center>
...
a.fcTotalAngsuran, a.fcAdm, a.fcProvisi, a.fcAsuransi, a.fcPpap AS fcPPAP, a.fcMaterai, a.fcPblt, a.fcSimpanan, a.fcRRP AS fcRRP,
...
WHERE a.fnStatus <> 9 AND LEFT(a.ftTrans_No,3) = 'PJU' AND a.fdTrans_date between '$startDate' AND '$endDate' ORDER BY a.fdTrans_date ASC");
	$no1 = 0;
