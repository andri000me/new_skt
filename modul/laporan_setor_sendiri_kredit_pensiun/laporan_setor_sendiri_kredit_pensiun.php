<?php
error_reporting(0);
//include("modul/laporan_setor_sendiri_kredit_pensiun/tampil.php");
include("modul/laporan_setor_sendiri_kredit_pensiun/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 var startDate;
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_setor_sendiri_kredit_pensiun/tampil.php ',
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_setor_sendiri_kredit_pensiun.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN SETOR SENDIRI KREDIT PENSIUN
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_setor_sendiri_kredit_pensiun.php";?>';" >
