<?php
error_reporting(0);
include("modul/laporan_daftar_nominatif_mikro/form_tgl.php");
$tgl = date("d");
$bln = date("m");
$thn = date("Y");
?> 
...
$(function () {
 ...
 var endDate;
	...
	//		console.log(endDate);			
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_daftar_nominatif_mikro.php?first='+awal+'&last='+akhir,
...
function showKelompok(menu) {
  sList = window.open('modul/laporan_daftar_nominatif_mikro/kelompok.php', 'Print', 'width=920,height=420,scrollbars=yes');
  }
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN DAFTAR NOMINATIF MIKRO <span style="color:red;">*</span>
      ...
      <li><h3 class="box-title">
          <input type="text" class="btn bg-purple dropdown-toggle" value=<?php echo "$thn-$bln-$tgl"; ?>  name="fdTrans_date" id="fdTrans_date" value="Pilih Tanggal" readonly=true onchange="act_tgl()">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_daftar_nominatif_mikro.php";?>';" >
