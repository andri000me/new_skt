...
// Hapus angsuran-umum
if ($module=='angsuran_umum' AND $act=='delete'){
  mysql_query("DELETE FROM txangsuran_umum_hdr WHERE fnid='$_GET[fnid]'");
  header('location:angsuran-umum.html');
}

// Input angsuran-umum
elseif ($module=='angsuran_umum' AND $act=='input'){
 
	  mysql_query("INSERT INTO txangsuran_umum_hdr(		ftTrans_No,
	  														ftBranch_Code,
															fdTrans_date,
															fcSimpanan,
															ftNotes,
...
// update angsuran-umum
elseif ($module=='angsuran_umum' AND $act=='update'){
 
	  mysql_query("UPDATE txangsuran_umum_hdr SET	fnStatus = '99',
