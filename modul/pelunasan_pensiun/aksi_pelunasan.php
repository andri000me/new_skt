...
// Hapus pelunasan_pensiun
if ($module=='pelunasan_pensiun' AND $act=='delete'){
  mysql_query("DELETE FROM txpelunasan_pensiun_hdr WHERE fnid='$_GET[fnid]'");
  header('location:pelunasan-pensiun.html');
}

// Input pelunasan_pensiun
elseif ($module=='pelunasan_pensiun' AND $act=='input'){
 
	  mysql_query("INSERT INTO txpelunasan_pensiun_hdr(		ftTrans_No,
	  														ftBranch_Code,
															fdTrans_date,
															fcSimpanan,
															ftNotes,
	  ...
	  mysql_query("UPDATE txpinjaman_pensiun_nasabah_hdr set fcOutstanding = fcOutstanding - '$fcPokokAngsuran' where ftTrans_No='$_POST[ftLoan_No]' and ftCustomer_Code='$_POST[ftCustomer_Code]'");
	  
  header('location:pelunasan-pensiun.html'); 

}

// update pelunasan_pensiun
elseif ($module=='pelunasan_pensiun' AND $act=='update'){
 
	  mysql_query("UPDATE txpelunasan_pensiun_hdr SET		fnStatus		= '99',
