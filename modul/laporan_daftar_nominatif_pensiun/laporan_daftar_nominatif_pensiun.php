<?php
error_reporting(0);
include("modul/laporan_daftar_nominatif_pensiun/form_tgl.php");
?>
<!-- daterange picker -->
...
$(function () {
 ...
 // //    date = date.toGMTString();
	...
	//		console.log(endDate);			
			$.ajax({
			type: 'GET',
			url: 'modul/laporan_daftar_nominatif_pensiun/tampil.php ',
		...
		$.ajax({
		    type: 'GET',
			url: 'excel/export_laporan_daftar_nominatif_pensiun.php?first='+awal+'&last='+akhir,
  ...
  default:
   ...
   ?>
    ...
    <section class="content-header">
      <h1>
       LAPORAN DAFTAR NOMINATIF PENSIUN
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
			...
			<!--		<li><h3 class="box-title">
					...
					echo "excel/export_laporan_daftar_nominatif_pensiun.php";?>';" >
