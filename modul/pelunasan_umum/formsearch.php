				...
				$tampil=mysql_query("SELECT a.*, b.fcPokokAngsuran * a.sisa AS fcPokokAngsuran, 
					...
					FROM (
							...
							FROM (
								...
								-IFNULL(b.fcPokokAngsuran,0), 0
								FROM txpinjaman_umum_hdr a
								LEFT JOIN txpelunasan_umum_hdr b ON a.ftCustomer_Code = b.ftCustomer_Code AND a.ftTrans_No = b.ftloan_No
								AND b.fnStatus = 1
								WHERE a.fnstatus = 1
					...
					LEFT JOIN txpinjaman_umum_hdr b ON a.ftCustomer_Code = b.ftCustomer_Code AND a.ftTrans_No = b.ftTrans_No
