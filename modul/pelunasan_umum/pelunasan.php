        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
			...
			// if ($_SESSION[leveluser]=='1' || $_SESSION[leveluser]=='4'){
			 ?>
              <h3 class="box-title"><input type="button" onclick="location.href='<?php echo "tambah-pelunasan-umum.html ";?>';" value="Tambah" class="btn bg-purple btn-flat margin"/></h3>
			 <?php
			 // }else{
				// echo""; 
			 // }
			...
			<div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM txpelunasan_umum_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC  ");
				}else{
				$tampil=mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat  FROM txpelunasan_umum_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening ORDER BY a.fnid DESC ");
				}
				$no = $posisi+1;
				...
				echo"				 				  
                  <td width='70px'><span class='label bg-gray disabled color-palette' onmouseover=\"this.style.cursor='pointer'\"><i class='fa fa-search' title='Edit $r[ftTrans_No]' onclick=\"location.href='edit-pelunasan-umum-$r[fnid].html';\"></i> &nbsp;&nbsp;&nbsp;  
				  ";
				  if($_SESSION[leveluser]=='1'){
				  echo"<a class='fa fa-trash-o' title='delete $r[ftNamaNasabah]'  href=javascript:confirmdelete('aksi-delete-pelunasan-umum-$r[fnid].html') ></a>";
				  }else{
					  echo"";
				  }
				  echo"</span></td>
...
<?php
 ...
 case "tambah":
  ...
  ?>
  <form id="myForm" autocomplete="off" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-tambah-pelunasan-umum.html" onSubmit="return validasi(this)">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Input Pelunasan Umum</h3>
        ...
        <div class="box-body" >
          ...
          <div class="row">
			...
			<script>
				  function getPelunasanBulanUmum(x) {
			 ...
			 <div class="form-group has-warning" id="tgl_pinsjam" >
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value=<?php echo "$thn-$bln-$tgl"; ?> name="fdTrans_date" id="fdTrans_date" onchange="getPelunasanBulanUmum(this.value);">
                </div>
                <!-- /.input group -->
              </div> 	
     ...
     <!-- /.box-header -->
	    ...
	    <div class="row">
		 ...
		 <div class="box-footer">
                <a  class="btn btn-default" href="pelunasan-umum.html">Cancel</a>
             </div>	
			  <!-- /.form-group -->
            </div>
			 <!-- /.RIGHT SIDE -->
 ...
 //HARUS DIRUBAH (setting email)
  case "edit":
   ...
   $edit = mysql_query("SELECT a.*,b.ftNamaNasabah,b.ftAlamat,b.ftNamaKelompok FROM txpelunasan_umum_hdr a LEFT JOIN tlnasabah b ON a.ftCustomer_Code=b.ftNoRekening WHERE a.fnid='$_GET[fnid]'");
...
?>	
  <form id="myForm" name="myForm" method="POST" enctype="multipart/form-data" action="aksi-edit-pelunasan-umum.html" onSubmit="return validasi(this)">
  <div id="printr">
  <section class="content">
   <div class="box box-info">
        <div class="box-header with-border">
