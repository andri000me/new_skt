...
header('Content-Disposition: attachment; filename="EXPORT CETAK BUKTI ANGSURAN MIKRO ' .$time2.'.xls"');
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>EXPORT CETAK BUKTI ANGSURAN MIKRO</title>
<style type="text/css"></style>
</head>
<body id="kelompok_date">
<span >EXPORT CETAK BUKTI ANGSURAN MIKRO</span><br>
