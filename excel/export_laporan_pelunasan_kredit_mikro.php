...
header('Content-Disposition: attachment; filename="EXPORT LAPORAN PELUNASAN KREDIT MIKRO ' .$time2.'.xls"');
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>EXPORT LAPORAN PELUNASAN KREDIT MIKRO</title>
<style type="text/css"></style>
</head>
<body id="export">
<span >EXPORT LAPORAN PELUNASAN KREDIT MIKRO</span><br>
<span >DATE  :  <?php echo $tanggal2;?> </span><br>
<span >TIME  :  <?php echo $time;?> </span><br><br>

<span ><center><b>LAPORAN PELUNASAN KREDIT MIKRO <?php echo $startDate;?> Sampai <?php echo $endDate;?></b></center></span ><br><br>
